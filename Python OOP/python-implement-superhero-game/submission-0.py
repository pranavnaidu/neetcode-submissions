...
class FlightHero(Hero):
    def __init__(self, name: str, power_level: int, health: int, flight_speed: int):
        self.name, self.power_level, self.health, self.flight_speed = name, power_level, health, flight_speed
...
class StrengthHero(Hero):
    def __init__(self, name: str, power_level: int, health: int, lifting_capacity: int):
        self.name, self.power_level, self.health, self.lifting_capacity = name, power_level, health, lifting_capacity
